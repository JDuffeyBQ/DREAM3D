'''
Test of Single Hexagonal Phase Equiaxed Pipeline example in Python
...
def single_hexagonal_phase_equiaxed():
    # Create Data Container Array
    dca = simpl.DataContainerArray()

    # Generate the StatsData
...
if __name__ == '__main__':
    single_hexagonal_phase_equiaxed()
